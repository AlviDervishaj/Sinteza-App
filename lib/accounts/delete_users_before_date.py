...
def main():
    ...
    usernames_to_remove = [username for username, user_data in data.items() if datetime.strptime(user_data["last_interaction"], "%Y-%m-%d %H:%M:%S.%f") < input_date and user["following_status"] == "none"]
